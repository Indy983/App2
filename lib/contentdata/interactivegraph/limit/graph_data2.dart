...
Widget getGraphWidget() {
  return GraphUIBase(
    functionDef: _GraphData2.functionDefinition,
    xMin: _GraphData2.xMin,
    xMax: _GraphData2.xMax,
    yMin: _GraphData2.yMin,
    yMax: _GraphData2.yMax,
    functionXMin: _GraphData2.functionXMin,
    functionXMax: _GraphData2.functionXMax,
    initialXLeft: _GraphData2.initialXLeft,
    initialXRight: _GraphData2.initialXRight,
    dragMinLeft: _GraphData2.dragMinLeft,
    dragMaxLeft: _GraphData2.dragMaxLeft,
    dragMinRight: _GraphData2.dragMinRight,
    dragMaxRight: _GraphData2.dragMaxRight,
    yScale: _GraphData2.yScale,
    functionStrokeWidth: _GraphData2.functionStrokeWidth,
    pointRadius: _GraphData2.pointRadius,
    axisStrokeWidth: _GraphData2.axisStrokeWidth,
    padding: _GraphData2.padding,
    xTicks: _GraphData2.xTicks,
    yTicks: _GraphData2.yTicks,
    functionColor: Color(_GraphData2.functionColor),
    leftPointColor: Color(_GraphData2.leftPointColor),
    rightPointColor: Color(_GraphData2.rightPointColor),
  );
}
