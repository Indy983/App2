...
Widget getGraphWidget() {
  return GraphUIBase(
    functionDef: _GraphData12.functionDefinition,
    xMin: _GraphData12.xMin,
    xMax: _GraphData12.xMax,
    yMin: _GraphData12.yMin,
    yMax: _GraphData12.yMax,
    functionXMin: _GraphData12.functionXMin,
    functionXMax: _GraphData12.functionXMax,
    initialXLeft: _GraphData12.initialXLeft,
    initialXRight: _GraphData12.initialXRight,
    dragMinLeft: _GraphData12.dragMinLeft,
    dragMaxLeft: _GraphData12.dragMaxLeft,
    dragMinRight: _GraphData12.dragMinRight,
    dragMaxRight: _GraphData12.dragMaxRight,
    yScale: _GraphData12.yScale,
    functionStrokeWidth: _GraphData12.functionStrokeWidth,
    pointRadius: _GraphData12.pointRadius,
    axisStrokeWidth: _GraphData12.axisStrokeWidth,
    padding: _GraphData12.padding,
    xTicks: _GraphData12.xTicks,
    yTicks: _GraphData12.yTicks,
    functionColor: Color(_GraphData12.functionColor),
    leftPointColor: Color(_GraphData12.leftPointColor),
    rightPointColor: Color(_GraphData12.rightPointColor),
  );
}
