...
Widget getGraphWidget() {
  return GraphUIBase(
    functionDef: _GraphData7.functionDefinition,
    xMin: _GraphData7.xMin,
    xMax: _GraphData7.xMax,
    yMin: _GraphData7.yMin,
    yMax: _GraphData7.yMax,
    functionXMin: _GraphData7.functionXMin,
    functionXMax: _GraphData7.functionXMax,
    initialXLeft: _GraphData7.initialXLeft,
    initialXRight: _GraphData7.initialXRight,
    dragMinLeft: _GraphData7.dragMinLeft,
    dragMaxLeft: _GraphData7.dragMaxLeft,
    dragMinRight: _GraphData7.dragMinRight,
    dragMaxRight: _GraphData7.dragMaxRight,
    yScale: _GraphData7.yScale,
    functionStrokeWidth: _GraphData7.functionStrokeWidth,
    pointRadius: _GraphData7.pointRadius,
    axisStrokeWidth: _GraphData7.axisStrokeWidth,
    padding: _GraphData7.padding,
    xTicks: _GraphData7.xTicks,
    yTicks: _GraphData7.yTicks,
    functionColor: Color(_GraphData7.functionColor),
    leftPointColor: Color(_GraphData7.leftPointColor),
    rightPointColor: Color(_GraphData7.rightPointColor),
  );
}
